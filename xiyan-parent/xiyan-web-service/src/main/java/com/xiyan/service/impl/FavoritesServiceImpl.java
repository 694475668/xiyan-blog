...
public class FavoritesServiceImpl implements FavoritesService {
    ...
    public BaseVO query(FavoritesQueryDTO favoritesQueryDTO, Integer id) {
        ...
        if (null == favoritesDO) {
            return new BaseVO(true, ErrorCodeEnum.E0702.getKey(), ErrorCodeEnum.E0702.getValue());
        }
        return new BaseVO(true, ErrorCodeEnum.E0701.getKey(), ErrorCodeEnum.E0701.getValue());
    }
}
