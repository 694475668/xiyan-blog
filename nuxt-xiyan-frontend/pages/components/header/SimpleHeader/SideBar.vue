    ...
    <div class="main-area">
      <div class="top-wrapper" @touchmove.stop>
        ...
        <div class="sidebar-menus">
          <div class="site-nav">
            <p>
              <nuxt-link to="/articleList" class="nav-link"
        ...
        <div class="sidebar-menus">
          <div class="site-nav">
            <p>
              <nuxt-link to="/codes" class="nav-link"
        ...
        <div class="sidebar-menus">
          <div class="site-nav">
            <p>
              <nuxt-link to="/talk" class="nav-link"
                ><i
                  @click="clone"
        ...
        <div class="sidebar-menus">
          <div class="site-nav">
            <p>
              <nuxt-link to="/tool" class="nav-link"
        ...
        <div class="sidebar-menus">
          <div class="site-nav">
            <p>
              <nuxt-link to="/recharge" class="nav-link">
            ...
            <p>
              <Dropdown trigger="click">
                ...
                <DropdownMenu slot="list">
                  <DropdownItem>
                    <nuxt-link to="/leaderboard" class="nav-link">
                  ...
                  <DropdownItem>
                    <nuxt-link to="/messageBoard" class="nav-link">
                  ...
                  <DropdownItem>
                    <nuxt-link to="/classroom" class="nav-link">
