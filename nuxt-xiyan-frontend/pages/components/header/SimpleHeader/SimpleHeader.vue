  ...
  <div class="simple-header">
      ...
      <div id="mobile-bar" v-show="show">
        ...
        <div class="avatar">
          <p class="flex">
            ...
            <a @click="isShow" style="margin-left: 5px;margin-top: 2px;"><img class="search" :src="searchUrl" /></a>
            <Dropdown trigger="click" style="margin-left: 5px">
              <a href="javascript:void(0)">
                <Avatar
                  ...
                  :src="userInfo.photo"
                />
                <nuxt-link v-if="userInfo.name == undefined" to="/login">
              ...
              <DropdownMenu slot="list" v-if="userInfo.name != undefined">
                <DropdownItem
                  ><nuxt-link class="inlineBlock" to="/"
                    >个人中心</nuxt-link
                  ></DropdownItem
                >
    ...
    <transition name="slide-fade">
      <div id="header" v-show="show">
        ...
        <ul id="nav">
          <li>
            <nuxt-link to="/articleList" class="nav-link contribute"
              ><span
...
"
          ...
          <li>
            <nuxt-link to="/codes" class="nav-link contribute"
              ><span
                ><svg class="icon" aria-hidden="true">
                  <use
...
"
          ...
          <li>
            <nuxt-link to="/talk" class="nav-link contribute"
              ><span
                ><svg class="icon" aria-hidden="true">
                  <use
...
"
          ...
          <li>
            <nuxt-link to="/tool" class="nav-link contribute"
              ><span
                ><svg class="icon" aria-hidden="true">
                  <use
...
"
          ...
          <li>
            <nuxt-link to="/recharge" class="nav-link contribute"
              ><span
                ><svg class="icon" aria-hidden="true">
                  <use
...
<script>
import SideBar from "@/pages/components/header/SimpleHeader/SideBar";
export default {
  components: {
    sidebar: SideBar,
  },
