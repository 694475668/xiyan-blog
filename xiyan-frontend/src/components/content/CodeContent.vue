...
<script>
import CodePageHeader from "@/components/views/code/CodePageHeader";
import CodePageContent from "@/components/views/code/CodePageContent";
import CodePageFooter from "@/components/views/code/CodePageFooter";
...
import { getCodeById, browse } from "@/api/code";
