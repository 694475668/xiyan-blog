          ...
          <a :href="'/' + topHotRead.urlType + '/' + topHotRead.linkId">
            ...
            <div class="tags">
              <Tag
                ...
                v-for="(tag, index) in topHotRead.tagList"
                :key="tag.id"
                >{{ tag.name }}</Tag
              >
            </div>
            <p class="info">
              ...
              <span class="likes"
                ><a
                  ><Icon type="heart"></Icon> {{ topHotRead.likeNum }}
                </a></span
              >
              <span class="comments"
                ><a
                  ><Icon type="compose"></Icon> {{ topHotRead.commentNum }}
                </a></span
              >
              <span class="readings"
                ><a><Icon type="eye"></Icon> {{ topHotRead.readNum }} </a></span
              >
            </p>
            <!--<div class="img">-->
          ...
          <li v-for="hotRead in hotReadList" :key="hotRead.id">
            <a :href="'/' + hotRead.urlType + '/' + hotRead.linkId">
              ...
              <p class="info">
                ...
                <span class="likes"
                  ><a href=""
                    ><Icon type="heart"></Icon> {{ hotRead.likeNum }}
                  </a></span
                >
                <span class="comments"
                  ><a href=""
                    ><Icon type="compose"></Icon> {{ hotRead.commentNum }}
                  </a></span
                >
                <span class="readings"
                  ><a href=""
                    ><Icon type="eye"></Icon> {{ hotRead.readNum }}
                  </a></span
                >
              </p>
            </a>
