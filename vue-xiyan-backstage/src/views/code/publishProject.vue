  ...
  <div class="bookNote-list-content">
    <el-row>
      <el-col :xs="24" :sm="24" :md="24" :lg="17">
        <el-form ref="article" :model="param" :label-width="labelWidth">
          ...
          <el-form-item label="所属语言：">
            <el-select v-model="param.type" style="width: 180px">
              <el-avatar
          ...
          <el-form-item>
            <el-button v-if="param.id == undefined" type="primary" @click="save"
              >发表源码</el-button
            >
            <el-button
...
<script>
import { imageDelete, imageUpload, fileUpload } from "@/api/upload";
