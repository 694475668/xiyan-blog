    ...
    <div class="box">
      ...
      <el-card class="box-card">
        <div slot="header" class="clearfix" style="margin-left: 1.5%">
          <span class="title-style">博客</span>
        </div>
        <el-table
          :data="list"
        ...
        >
          ...
          <el-table-column
            ...
            prop="conCount"
          ></el-table-column>
          <el-table-column align="center" label="好文">
            <template slot-scope="scope">
              <el-switch
                :value="scope.row.good == 1 ? true : false"
                :active-text="scope.row.good == 1 ? '是' : ''"
                :inactive-text="scope.row.good == 0 ? '否' : ''"
                active-color="#D52BB3"
...
<script>
import { list, del, popular, review } from "@/api/article";
...
export default {
  ...
  methods: {
    ...
    add() {
      this.$router.push({ path: "/article/postArticle" });
    },
  },
};
</script>
